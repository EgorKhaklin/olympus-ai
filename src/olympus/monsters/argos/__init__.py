...
from olympus.monsters.argos.base import Eye, EyeFinding, Pheromone, KIND_INFO, KIND_DRIFT, KIND_ALERT
from olympus.monsters.argos.colony import colony, Colony
