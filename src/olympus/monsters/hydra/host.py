...
def _attach_defaults() -> None:
    from olympus.monsters.hydra.heads.head_cosmogony import HeadCosmogony
    from olympus.monsters.hydra.heads.head_pantheon import HeadPantheon
    from olympus.monsters.hydra.heads.head_styx import HeadStyx
    from olympus.monsters.hydra.heads.head_journal import HeadJournal
    from olympus.monsters.hydra.heads.head_oaths import HeadOaths
    from olympus.monsters.hydra.heads.head_lifecycle import HeadLifecycle
    from olympus.monsters.hydra.heads.head_substrate import HeadSubstrate
    from olympus.monsters.hydra.heads.head_apollo import HeadApollo
    from olympus.monsters.hydra.heads.head_immortal import HeadImmortal
