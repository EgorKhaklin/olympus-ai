...
**Olympus exists.** The pantheon is complete: forty-three named gods plus the swarm tier of Argos's hundred eyes. Every tier of Greek cosmogony is mapped to a structural concern in the substrate.
...
Nine mortal heads (cognitive, security, performance, mission, adversary, swarm, demes, substrate, trajectory) plus the immortal CM head — the watcher that watches the watchers.

### What Argos carries

The swarm tier: **Eyes** (~33 observation specialists), **Satyrs** (9 lower-cadence concrete checks), **Demes** (6 civic-class observers: mantis, demarchos, hippeus, demos, tamias, ephoros), **Phalanges** (11 battle formations grouping Eyes by concern).
